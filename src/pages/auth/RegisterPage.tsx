...
export default function RegisterPage() {
  ...
  const passwordRequirements = [
    { label: t('auth.passwordReqLength'), test: (v: string) => v.length >= 6 },
    { label: t('auth.passwordReqNumber'), test: (v: string) => /\d/.test(v) },
    { label: t('auth.passwordReqUppercase'), test: (v: string) => /[A-Z]/.test(v) },
  ];
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="flex items-start space-x-2 pt-2">
                ...
                <Label htmlFor="terms" className="text-sm font-normal leading-tight cursor-pointer">
                  {t('auth.agreeToTerms')}{' '}
                  <a href="#" className="text-primary hover:underline">{t('common.termsOfService')}</a>
                  {' '}{t('common.and')}{' '}
                  <a href="#" className="text-primary hover:underline">{t('common.privacyPolicy')}</a>
                </Label>
              </div>
